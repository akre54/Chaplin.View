...
(function (factory) {
  ...
  optionNames: View.prototype.optionNames.concat(['renderItems', 'itemView']),
  ...
  insertView: function (item, view, position, enableAnimation) {
    ...
    var included = typeof @filterer === 'function' ?
    ...
    insertView(this.$list, elem, position, length, this.itemSelector);
  ...
  dispose: function() {
    ...
    // Self-disposal.
    View.prototype.disposed.apply(this, arguments);
